...
* [`src/circle/`](src/circle/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/circle/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `circle` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/circle/config.cljs) defaults to `true` in
