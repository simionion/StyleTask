...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k32029,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32029,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__32045){
var vec__32046 = p__32045;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32046,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32046,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32028){
var self__ = this;
var G__32028__$1 = this;
return (new cljs.core.RecordIter((0),G__32028__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k","k",-2146297393),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32030,other32031){
var self__ = this;
var this32030__$1 = this;
return (((!((other32031 == null)))) && ((((this32030__$1.constructor === other32031.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32030__$1.k,other32031.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32030__$1.namespaced_QMARK_,other32031.namespaced_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32030__$1.__extmap,other32031.__extmap)))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k32029){
var self__ = this;
var this__4509__auto____$1 = this;
var G__32086 = k32029;
var G__32086__$1 = (((G__32086 instanceof cljs.core.Keyword))?G__32086.fqn:null);
switch (G__32086__$1) {
case "k":
case "namespaced?":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32029);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__32028){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__32088 = cljs.core.keyword_identical_QMARK_;
var expr__32089 = k__4511__auto__;
if(cljs.core.truth_((pred__32088.cljs$core$IFn$_invoke$arity$2 ? pred__32088.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__32089) : pred__32088.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__32089)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__32028,self__.namespaced_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32088.cljs$core$IFn$_invoke$arity$2 ? pred__32088.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__32089) : pred__32088.call(null,new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__32089)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__32028,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__32028),null));
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__32028){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,G__32028,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__32036){
var extmap__4542__auto__ = (function (){var G__32112 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32036,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], 0));
if(cljs.core.record_QMARK_(G__32036)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32112);
} else {
return G__32112;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__32036),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877).cljs$core$IFn$_invoke$arity$1(G__32036),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var len__4864__auto___32161 = arguments.length;
var i__4865__auto___32162 = (0);
while(true){
if((i__4865__auto___32162 < len__4864__auto___32161)){
args__4870__auto__.push((arguments[i__4865__auto___32162]));

var G__32163 = (i__4865__auto___32162 + (1));
i__4865__auto___32162 = G__32163;
continue;
} else {
}
break;
...
(rewrite_clj.node.keyword.keyword_node.cljs$core$IFn$_invoke$arity$variadic = (function (k,p__32118){
var vec__32119 = p__32118;
var namespaced_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32119,(0),null);
...
/** @this {Function} */
(rewrite_clj.node.keyword.keyword_node.cljs$lang$applyTo = (function (seq32115){
var G__32116 = cljs.core.first(seq32115);
var seq32115__$1 = cljs.core.next(seq32115);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32116,seq32115__$1);
}));
