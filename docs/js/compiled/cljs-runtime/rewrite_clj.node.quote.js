...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k32055,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32055,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__32068){
var vec__32069 = p__32068;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32069,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32069,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32054){
var self__ = this;
var G__32054__$1 = this;
return (new cljs.core.RecordIter((0),G__32054__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32056,other32057){
var self__ = this;
var this32056__$1 = this;
return (((!((other32057 == null)))) && ((((this32056__$1.constructor === other32057.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32056__$1.tag,other32057.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32056__$1.prefix,other32057.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32056__$1.sym,other32057.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32056__$1.children,other32057.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32056__$1.__extmap,other32057.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k32055){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32055);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__32054){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__32176 = cljs.core.keyword_identical_QMARK_;
var expr__32177 = k__4511__auto__;
if(cljs.core.truth_((pred__32176.cljs$core$IFn$_invoke$arity$2 ? pred__32176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__32177) : pred__32176.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__32177)))){
return (new rewrite_clj.node.quote.QuoteNode(G__32054,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32176.cljs$core$IFn$_invoke$arity$2 ? pred__32176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__32177) : pred__32176.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__32177)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__32054,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32176.cljs$core$IFn$_invoke$arity$2 ? pred__32176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__32177) : pred__32176.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__32177)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__32054,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32176.cljs$core$IFn$_invoke$arity$2 ? pred__32176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__32177) : pred__32176.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__32177)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__32054,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__32054),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__32054){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__32054,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__32059){
var extmap__4542__auto__ = (function (){var G__32180 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32059,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__32059)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32180);
} else {
return G__32180;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__32059),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__32059),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__32059),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__32059),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var G__32203 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__32203;
continue;
}
break;
...
var G__32205 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__32205;
continue;
}
break;
...
var G__32206 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__32206;
continue;
}
break;
...
var G__32208 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__32208;
continue;
}
break;
