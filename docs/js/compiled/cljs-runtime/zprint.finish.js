...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__31929_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31929_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__31929_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__31933){
var vec__31938 = p__31933;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31938,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31938,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__31941,s,color,element,idx){
var map__31942 = p__31941;
var map__31942__$1 = cljs.core.__destructure_map(map__31942);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31942__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31942__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31942__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__31945 = (function (){var or__4253__auto__ = color;
...
var fexpr__31944 = (function (){var G__31946 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__31946) : style_map.call(null,G__31946));
})();
return (fexpr__31944.cljs$core$IFn$_invoke$arity$1 ? fexpr__31944.cljs$core$IFn$_invoke$arity$1(G__31945) : fexpr__31944.call(null,G__31945));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__31947){
var vec__31948 = p__31947;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31948,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31948,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31948,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__31951){
var vec__31952 = p__31951;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31952,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31952,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31952,(2),null);
...
var G__32093 = cljs.core.next(ssv);
var G__32094 = (this_ssv == null);
var G__32095 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__32096 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__32093;
doing_nil_QMARK_ = G__32094;
last_elide = G__32095;
out = G__32096;
continue;
}
...
var vec__31958 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31958,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31958,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31958,(2),null);
...
var G__32099 = cljs.core.next(remaining_cvec);
var G__32100 = new_idx;
var G__32101 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__32099;
idx = G__32100;
out = G__32101;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__31967,cursor_vec){
var vec__31968 = p__31967;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31968,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31968,(1),null);
var focus_vec = vec__31968;
...
var vec__31973 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31973,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31973,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__31978){
var vec__31979 = p__31978;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31979,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31979,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__31993,existing_count){
var vec__31995 = p__31993;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31995,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31995,(1),null);
...
return cljs.core.filterv((function (p1__31987_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__31987_SHARP_))));
...
var vec__32006 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32006,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32006,(1),null);
var cvec_element = vec__32006;
if((cvec_element == null)){
var G__32122 = cljs.core.next(cvec_nl);
var G__32123 = (idx + (1));
var G__32124 = start;
var G__32125 = out;
cvec_nl = G__32122;
...
var G__32126 = cljs.core.next(cvec_nl);
var G__32127 = (idx + (1));
var G__32128 = idx;
var G__32129 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__32126;
idx = G__32127;
start = G__32128;
out = G__32129;
...
var G__32130 = cljs.core.next(cvec_nl);
var G__32131 = (idx + (1));
var G__32132 = (idx + (1));
var G__32133 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__32130;
idx = G__32131;
start = G__32132;
out = G__32133;
...
var G__32135 = cljs.core.next(cvec_nl);
var G__32136 = (idx + (1));
var G__32137 = idx;
...
var G__32139 = cljs.core.next(cvec_nl);
var G__32140 = (idx + (1));
var G__32141 = start;
var G__32142 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__32139;
idx = G__32140;
start = G__32141;
out = G__32142;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__32013_SHARP_,p2__32012_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__32012_SHARP_)){
return cljs.core.reduced(p1__32013_SHARP_);
} else {
return (p1__32013_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__32015,p__32016){
var vec__32019 = p__32015;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32019,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32019,(1),null);
var vec__32022 = p__32016;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32022,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32022,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__32062,cvec,focus_vec){
var map__32065 = p__32062;
var map__32065__$1 = cljs.core.__destructure_map(map__32065);
var options = map__32065__$1;
var map__32066 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32065__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__32066__$1 = cljs.core.__destructure_map(map__32066);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32066__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32066__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32066__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32058_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__32058_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
