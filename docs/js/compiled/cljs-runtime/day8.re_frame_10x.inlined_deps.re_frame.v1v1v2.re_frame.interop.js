...
return [(function (){var pred__27921 = cljs.core.instance_QMARK_;
var expr__27922 = reactive_val;
if(cljs.core.truth_((pred__27921.cljs$core$IFn$_invoke$arity$2 ? pred__27921.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__27922) : pred__27921.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__27922)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27921.cljs$core$IFn$_invoke$arity$2 ? pred__27921.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__27922) : pred__27921.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__27922)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27921.cljs$core$IFn$_invoke$arity$2 ? pred__27921.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__27922) : pred__27921.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__27922)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27921.cljs$core$IFn$_invoke$arity$2 ? pred__27921.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__27922) : pred__27921.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__27922)))){
return "tr";
} else {
return "other";
}
