...
var G__33213 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__33213;
continue;
} else {
var G__33214 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__33214;
continue;
}
} else {
var G__33215 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__33215;
continue;
}
}
...
var G__33186 = zloc;
var G__33187 = (function (){var G__33188 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__33189 = zloc;
var G__33189__$1 = (((G__33189 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__33189) : rewrite_clj.zip.node.call(null,G__33189)));
if((G__33189__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__33189__$1) : zprint.zutil.edn_STAR_.call(null,G__33189__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__33188) : rewrite_clj.zip.root.call(null,G__33188));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__33186,G__33187) : rewrite_clj.zip.replace.call(null,G__33186,G__33187));
});
/**
...
var G__33224 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__33224;
continue;
}
break;
...
var G__33226 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__33227 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__33226;
out = G__33227;
continue;
} else {
...
var G__33231 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__33232 = cljs.core.next(new_loc);
var G__33233 = replaced_loc;
nloc = G__33231;
new_loc = G__33232;
last_loc = G__33233;
continue;
...
return zprint.rewrite.sort_val((function (){var G__33205 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__33205) : rewrite_clj.zip.down.call(null,G__33205));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__33206_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__33206_SHARP_) : rewrite_clj.zip.tag.call(null,p1__33206_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__33206_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__33206_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
