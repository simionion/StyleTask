...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k32042,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32042,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__32072){
var vec__32074 = p__32072;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32074,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32074,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32041){
var self__ = this;
var G__32041__$1 = this;
return (new cljs.core.RecordIter((0),G__32041__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32043,other32044){
var self__ = this;
var this32043__$1 = this;
return (((!((other32044 == null)))) && ((((this32043__$1.constructor === other32044.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32043__$1.children,other32044.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32043__$1.__extmap,other32044.__extmap)))))));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k32042){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32042);

}
}));

(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__32041){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__32103 = cljs.core.keyword_identical_QMARK_;
var expr__32104 = k__4511__auto__;
if(cljs.core.truth_((pred__32103.cljs$core$IFn$_invoke$arity$2 ? pred__32103.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__32104) : pred__32103.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__32104)))){
return (new rewrite_clj.node.forms.FormsNode(G__32041,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__32041),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__32041){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__32041,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__32050){
var extmap__4542__auto__ = (function (){var G__32113 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__32050,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__32050)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32113);
} else {
return G__32113;
}
})();
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__32050),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
