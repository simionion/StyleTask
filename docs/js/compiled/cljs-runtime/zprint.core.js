...
var vec__34686 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__34689 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34689,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34689,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34686,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34686,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__34692){
var vec__34693 = p__34692;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34693,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34693,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34696,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34696,(1),null);
...
var vec__34712 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34712,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34712,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34712,(2),null);
var vec__34716 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34716,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34716,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34716,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__34721){
var vec__34722 = p__34721;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34722,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34722,(1),null);
...
var vec__34725 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34725,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34725,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34725,(2),null);
...
var vec__34737 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34737,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34737,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34737,(2),null);
var tuple = vec__34737;
...
var G__34833 = cljs.core.next(style_vec);
var G__34834 = ends_w_blanks_QMARK_;
var G__34835 = tuple;
var G__34836 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__34833;
previous_ends_w_blanks_QMARK_ = G__34834;
previous_tuple = G__34835;
out = G__34836;
continue;
}
break;
...
var len__4864__auto___34837 = arguments.length;
var i__4865__auto___34838 = (0);
while(true){
if((i__4865__auto___34838 < len__4864__auto___34837)){
args__4870__auto__.push((arguments[i__4865__auto___34838]));

var G__34839 = (i__4865__auto___34838 + (1));
i__4865__auto___34838 = G__34839;
continue;
} else {
}
break;
...
var vec__34743 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34743,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34743,(1),null);
...
var result = (function (){var G__34746 = zprint.core.parse_string_all_options(rest_options);
var G__34747 = zprint.core.zprint_str_internal;
var G__34748 = ":parse-string-all? call";
var G__34749 = (function (){var G__34750 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__34750) : zprint.zutil.edn_STAR_.call(null,G__34750));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__34746,G__34747,G__34748,G__34749) : zprint.core.process_multiple_forms.call(null,G__34746,G__34747,G__34748,G__34749));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__34751 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34751,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34751,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq34740){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34741,G__34742,seq34740__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq34755){
var G__34756 = cljs.core.first(seq34755);
var seq34755__$1 = cljs.core.next(seq34755);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34756,seq34755__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___34852 = arguments.length;
var i__4865__auto___34853 = (0);
while(true){
if((i__4865__auto___34853 < len__4864__auto___34852)){
args__4870__auto__.push((arguments[i__4865__auto___34853]));

var G__34854 = (i__4865__auto___34853 + (1));
i__4865__auto___34853 = G__34854;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq34757){
var G__34758 = cljs.core.first(seq34757);
var seq34757__$1 = cljs.core.next(seq34757);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34758,seq34757__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___34856 = arguments.length;
var i__4865__auto___34857 = (0);
while(true){
if((i__4865__auto___34857 < len__4864__auto___34856)){
args__4870__auto__.push((arguments[i__4865__auto___34857]));

var G__34858 = (i__4865__auto___34857 + (1));
i__4865__auto___34857 = G__34858;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq34759){
var G__34760 = cljs.core.first(seq34759);
var seq34759__$1 = cljs.core.next(seq34759);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34760,seq34759__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___34861 = arguments.length;
var i__4865__auto___34862 = (0);
while(true){
if((i__4865__auto___34862 < len__4864__auto___34861)){
args__4870__auto__.push((arguments[i__4865__auto___34862]));

var G__34863 = (i__4865__auto___34862 + (1));
i__4865__auto___34862 = G__34863;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq34762){
var G__34763 = cljs.core.first(seq34762);
var seq34762__$1 = cljs.core.next(seq34762);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34763,seq34762__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__34767,form){
var vec__34768 = p__34767;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34768,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34768,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34768,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34768,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__34771 = (cljs.core.truth_((function (){var and__4251__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34771,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34771,(1),null);
...
var G__34873 = cljs.core.next(sos);
var G__34874 = comment_QMARK_;
var G__34875 = (function (){var or__4253__auto__ = (!(empty_string_QMARK_));
if(or__4253__auto__){
return or__4253__auto__;
} else {
...
var G__34876 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__34873;
previous_comment_QMARK_ = G__34874;
start_interpolating_QMARK_ = G__34875;
out = G__34876;
continue;
}
break;
...
try{var vec__34783 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34783,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34783,(1),null);
...
var vec__34786 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34786,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34786,(1),null);
...
var vec__34789 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34789,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34789,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34789,(2),null);
...
var forms = (function (){var G__34799 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__34799) : zprint.zutil.edn_STAR_.call(null,G__34799));
})();
