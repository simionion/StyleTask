...
if((c === "\n")){
var G__32463 = escape_QMARK_;
var G__32464 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__32463;
lines = G__32464;
continue;
} else {
buf.append(c);

var G__32465 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__32466 = lines;
escape_QMARK_ = G__32465;
lines = G__32466;
continue;
...
var G__32458 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__32458) : rewrite_clj.node.string_node.call(null,G__32458));
});
...
var G__32461 = cljs.core.re_pattern(regex);
var G__32462 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__32461,G__32462) : rewrite_clj.node.token_node.call(null,G__32461,G__32462));
});
