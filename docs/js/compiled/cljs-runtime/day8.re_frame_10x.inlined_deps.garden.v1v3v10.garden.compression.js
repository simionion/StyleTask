 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__28483){
var vec__28484 = p__28483;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28484,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28484,(1),null);
return (function (s){
...
var len__4864__auto___28517 = arguments.length;
var i__4865__auto___28518 = (0);
while(true){
if((i__4865__auto___28518 < len__4864__auto___28517)){
args__4870__auto__.push((arguments[i__4865__auto___28518]));

var G__28519 = (i__4865__auto___28518 + (1));
i__4865__auto___28518 = G__28519;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__28487_SHARP_){
return (p1__28487_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__28487_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__28487_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq28488){
...
var map__28507 = temp__5751__auto__;
var map__28507__$1 = cljs.core.__destructure_map(map__28507);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28507__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28507__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28507__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__28521 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__28522 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__28512 = tag;
