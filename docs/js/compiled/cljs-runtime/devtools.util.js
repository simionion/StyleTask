...
var len__4864__auto___29376 = arguments.length;
var i__4865__auto___29377 = (0);
while(true){
if((i__4865__auto___29377 < len__4864__auto___29376)){
args__4870__auto__.push((arguments[i__4865__auto___29377]));

var G__29378 = (i__4865__auto___29377 + (1));
i__4865__auto___29377 = G__29378;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__29212_29379 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29213_29380 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29214_29381 = true;
var _STAR_print_fn_STAR__temp_val__29215_29382 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29214_29381);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29215_29382);

try{var _STAR_print_level_STAR__orig_val__29216_29383 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29217_29384 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29217_29384);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29216_29383);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29213_29380);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29212_29379);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq29210){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq29210));
}));
...
var new_formatters = current_formatters.filter((function (p1__29289_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__29289_SHARP_)));
}));
...
var G__29304_29396 = f;
var target__27123__auto___29397 = G__29304_29396;
if(cljs.core.truth_(target__27123__auto___29397)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29304_29396)].join(''),"\n","target__27123__auto__"].join('')));
}

(target__27123__auto___29397["toString"] = (function (){
...
var G__29309_29398 = "%c%s";
var G__29310_29399 = "color:transparent";
var G__29311_29400 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__29309_29398,G__29310_29399,G__29311_29400) : f.call(null,G__29309_29398,G__29310_29399,G__29311_29400));
...
var args__4870__auto__ = [];
var len__4864__auto___29403 = arguments.length;
var i__4865__auto___29404 = (0);
while(true){
if((i__4865__auto___29404 < len__4864__auto___29403)){
args__4870__auto__.push((arguments[i__4865__auto___29404]));

var G__29407 = (i__4865__auto___29404 + (1));
i__4865__auto___29404 = G__29407;
continue;
} else {
}
break;
...
var vec__29337 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29337,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29337,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__29409__delegate = function (add_fmt,add_args){
...
var G__29409 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__29410__i = 0, G__29410__a = new Array(arguments.length -  1);
while (G__29410__i < G__29410__a.length) {G__29410__a[G__29410__i] = arguments[G__29410__i + 1]; ++G__29410__i;}
  add_args = new cljs.core.IndexedSeq(G__29410__a,0,null);
} 
return G__29409__delegate.call(this,add_fmt,add_args);};
G__29409.cljs$lang$maxFixedArity = 1;
G__29409.cljs$lang$applyTo = (function (arglist__29411){
var add_fmt = cljs.core.first(arglist__29411);
var add_args = cljs.core.rest(arglist__29411);
return G__29409__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq29326){
var G__29327 = cljs.core.first(seq29326);
var seq29326__$1 = cljs.core.next(seq29326);
var G__29328 = cljs.core.first(seq29326__$1);
var seq29326__$2 = cljs.core.next(seq29326__$1);
var G__29329 = cljs.core.first(seq29326__$2);
var seq29326__$3 = cljs.core.next(seq29326__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29327,G__29328,G__29329,seq29326__$3);
}));
...
var seq__29354 = cljs.core.seq(features);
var chunk__29355 = null;
var count__29356 = (0);
var i__29357 = (0);
while(true){
if((i__29357 < count__29356)){
var feature = chunk__29355.cljs$core$IIndexed$_nth$arity$2(null,i__29357);
...
var G__29413 = seq__29354;
var G__29414 = chunk__29355;
var G__29415 = count__29356;
var G__29416 = (i__29357 + (1));
seq__29354 = G__29413;
chunk__29355 = G__29414;
count__29356 = G__29415;
i__29357 = G__29416;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__29354);
if(temp__5753__auto__){
var seq__29354__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__29354__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__29354__$1);
var G__29417 = cljs.core.chunk_rest(seq__29354__$1);
var G__29418 = c__4679__auto__;
var G__29419 = cljs.core.count(c__4679__auto__);
var G__29420 = (0);
seq__29354 = G__29417;
chunk__29355 = G__29418;
count__29356 = G__29419;
i__29357 = G__29420;
continue;
} else {
var feature = cljs.core.first(seq__29354__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29421 = cljs.core.next(seq__29354__$1);
var G__29422 = null;
var G__29423 = (0);
var G__29424 = (0);
seq__29354 = G__29421;
chunk__29355 = G__29422;
count__29356 = G__29423;
i__29357 = G__29424;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o29373 = temp__5751__auto__;
return (o29373["version"]);
} else {
return null;
}
})() == null);
