...
var G__32722 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__32722__$1 = (((G__32722 == null))?null:cljs.core.iterate((function (loc){
...
var G__32722__$2 = (((G__32722__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__32722__$1));
var G__32722__$3 = (((G__32722__$2 == null))?null:cljs.core.last(G__32722__$2));
if((G__32722__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__32722__$3);
}
} else {
return zloc;
}
...
var G__32729 = rewrite_clj.zip.move.right(v);
var G__32730 = rewrite_clj.zip.move.up(v);
loc = G__32729;
parent = G__32730;
continue;
} else {
var G__32731 = rewrite_clj.zip.move.right(v0);
var G__32732 = parent;
loc = G__32731;
parent = G__32732;
continue;
...
var G__32733 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__32734 = rewrite_clj.zip.move.up(v);
loc = G__32733;
parent = G__32734;
continue;
} else {
var G__32735 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__32736 = parent;
loc = G__32735;
parent = G__32736;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__32725 = zloc;
var G__32725__$1 = (((G__32725 == null))?null:rewrite_clj.zip.move.down(G__32725));
var G__32725__$2 = (((G__32725__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__32725__$1,k));
if((G__32725__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__32725__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__32726 = rewrite_clj.zip.move.down(zloc);
var G__32726__$1 = (((G__32726 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__32726));
if((G__32726__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__32726__$1);
}
})(),k);
}
});
