...
var i_32354 = (0);
while(true){
if((i_32354 < arr.length)){
(arr[i_32354] = null);

var G__32355 = (i_32354 + (1));
i_32354 = G__32355;
continue;
} else {
}
...
var i_32375 = (self__.level + (1));
while(true){
if((i_32375 <= (new_level + (1)))){
(update[i_32375] = self__.header);

var G__32377 = (i_32375 + (1));
i_32375 = G__32377;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32378 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32378[i]));
} else {
x__$2.forward.push((((i < links_32378.length))?(links_32378[i]):null));
}

if((i < links_32378.length)){
(links_32378[i] = x__$2);
} else {
links_32378.push(x__$2);
}
...
var i_32384 = (0);
while(true){
if((i_32384 <= self__.level)){
var links_32385 = (update[i_32384]).forward;
if((x__$1 === (((i_32384 < links_32385.length))?(links_32385[i_32384]):null))){
(links_32385[i_32384] = (x__$1.forward[i_32384]));

var G__32386 = (i_32384 + (1));
i_32384 = G__32386;
continue;
} else {
var G__32387 = (i_32384 + (1));
i_32384 = G__32387;
continue;
}
} else {
