...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30639 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30639(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30646 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30646(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30647 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30647(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30648 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30648(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30649 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30649(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30651 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30651(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30652 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30652(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30654 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30654(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30655 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30655(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30656 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30656(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30657 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30657(b);
}
});
