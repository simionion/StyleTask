 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__29821,right){
var map__29822 = p__29821;
var map__29822__$1 = cljs.core.__destructure_map(map__29822);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29822__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29822__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__29824 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29824,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29824,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29824,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29831__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29832 = u(y);
var map__29832__$1 = cljs.core.__destructure_map(map__29832);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29832__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__29862__delegate = function (x,y,more){
...
var G__29863__i = 0, G__29863__a = new Array(arguments.length -  2);
while (G__29863__i < G__29863__a.length) {G__29863__a[G__29863__i] = arguments[G__29863__i + 2]; ++G__29863__i;}
  more = new cljs.core.IndexedSeq(G__29863__a,0,null);
} 
...
G__29867 = new cljs.core.IndexedSeq(G__29868__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29867);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29833__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29834 = u(y);
var map__29834__$1 = cljs.core.__destructure_map(map__29834);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29834__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__29870__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__29872__i = 0, G__29872__a = new Array(arguments.length -  2);
while (G__29872__i < G__29872__a.length) {G__29872__a[G__29872__i] = arguments[G__29872__i + 2]; ++G__29872__i;}
  more = new cljs.core.IndexedSeq(G__29872__a,0,null);
} 
return G__29870__delegate.call(this,x,y,more);};
G__29870.cljs$lang$maxFixedArity = 2;
G__29870.cljs$lang$applyTo = (function (arglist__29873){
var x = cljs.core.first(arglist__29873);
arglist__29873 = cljs.core.next(arglist__29873);
var y = cljs.core.first(arglist__29873);
var more = cljs.core.rest(arglist__29873);
...
var G__29874 = null;
if (arguments.length > 2) {
var G__29875__i = 0, G__29875__a = new Array(arguments.length -  2);
while (G__29875__i < G__29875__a.length) {G__29875__a[G__29875__i] = arguments[G__29875__i + 2]; ++G__29875__i;}
G__29874 = new cljs.core.IndexedSeq(G__29875__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29874);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29835__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29836 = u(y);
var map__29836__$1 = cljs.core.__destructure_map(map__29836);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29836__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__29878__delegate = function (x,y,more){
...
var G__29878 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__29879__i = 0, G__29879__a = new Array(arguments.length -  2);
while (G__29879__i < G__29879__a.length) {G__29879__a[G__29879__i] = arguments[G__29879__i + 2]; ++G__29879__i;}
  more = new cljs.core.IndexedSeq(G__29879__a,0,null);
} 
return G__29878__delegate.call(this,x,y,more);};
G__29878.cljs$lang$maxFixedArity = 2;
G__29878.cljs$lang$applyTo = (function (arglist__29880){
var x = cljs.core.first(arglist__29880);
arglist__29880 = cljs.core.next(arglist__29880);
var y = cljs.core.first(arglist__29880);
var more = cljs.core.rest(arglist__29880);
return G__29878__delegate(x,y,more);
});
...
var G__29881 = null;
if (arguments.length > 2) {
var G__29882__i = 0, G__29882__a = new Array(arguments.length -  2);
while (G__29882__i < G__29882__a.length) {G__29882__a[G__29882__i] = arguments[G__29882__i + 2]; ++G__29882__i;}
G__29881 = new cljs.core.IndexedSeq(G__29882__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29881);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29842__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29843 = u(y);
var map__29843__$1 = cljs.core.__destructure_map(map__29843);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29843__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__29889__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__29893__i = 0, G__29893__a = new Array(arguments.length -  2);
while (G__29893__i < G__29893__a.length) {G__29893__a[G__29893__i] = arguments[G__29893__i + 2]; ++G__29893__i;}
  more = new cljs.core.IndexedSeq(G__29893__a,0,null);
} 
return G__29889__delegate.call(this,x,y,more);};
G__29889.cljs$lang$maxFixedArity = 2;
G__29889.cljs$lang$applyTo = (function (arglist__29894){
var x = cljs.core.first(arglist__29894);
arglist__29894 = cljs.core.next(arglist__29894);
var y = cljs.core.first(arglist__29894);
var more = cljs.core.rest(arglist__29894);
...
var G__29895 = null;
if (arguments.length > 2) {
var G__29896__i = 0, G__29896__a = new Array(arguments.length -  2);
while (G__29896__i < G__29896__a.length) {G__29896__a[G__29896__i] = arguments[G__29896__i + 2]; ++G__29896__i;}
G__29895 = new cljs.core.IndexedSeq(G__29896__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29895);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
