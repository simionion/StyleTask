...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k32264,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32264,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__32272){
var vec__32274 = p__32272;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32274,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32274,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32263){
var self__ = this;
var G__32263__$1 = this;
return (new cljs.core.RecordIter((0),G__32263__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32265,other32266){
var self__ = this;
var this32265__$1 = this;
return (((!((other32266 == null)))) && ((((this32265__$1.constructor === other32266.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32265__$1.value,other32266.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32265__$1.string_value,other32266.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32265__$1.__extmap,other32266.__extmap)))))))));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k32264){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32264);

}
}));

(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__32263){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__32287 = cljs.core.keyword_identical_QMARK_;
var expr__32288 = k__4511__auto__;
if(cljs.core.truth_((pred__32287.cljs$core$IFn$_invoke$arity$2 ? pred__32287.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__32288) : pred__32287.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__32288)))){
return (new rewrite_clj.node.token.TokenNode(G__32263,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32287.cljs$core$IFn$_invoke$arity$2 ? pred__32287.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__32288) : pred__32287.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__32288)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__32263,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__32263),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__32263){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__32263,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__32267){
var extmap__4542__auto__ = (function (){var G__32291 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32267,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__32267)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32291);
} else {
return G__32291;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__32267),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__32267),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
